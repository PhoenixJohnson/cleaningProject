xyxPay.directive('fadeIn', function () {
    return {
...
xyxPay.directive('loadingContainer', function () {
    return {
        restrict: 'A',
        scope: false,
...
xyxPay.directive('noty', function () {
...
xyxPay.directive('dlEnterKey', function() {
...
xyxPay.directive('repeatItem', function($animate) {
    return {
        restrict: 'A',
        scope: {
