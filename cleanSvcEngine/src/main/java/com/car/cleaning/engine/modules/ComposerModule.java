...
import com.car.cleaning.engine.exception.SvcModuleException;
...
public abstract class ComposerModule<OUTPUT_OBJ> extends BaseModule {
    ...
    abstract protected void buildBasicInfo(EngineContext engineContext, OUTPUT_OBJ outputRequest);

    abstract protected void buildCoreInfo(EngineContext engineContext, OUTPUT_OBJ outputRequest) throws SvcModuleException;
